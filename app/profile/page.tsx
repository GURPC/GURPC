          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6">
            ...
            <div className="flex justify-end">
              <button
                ...
                className="px-6 py-2.5 bg-gray-900 hover:bg-gray-800 dark:bg-gray-800 dark:hover:bg-gray-700 disabled:bg-gray-100 disabled:dark:bg-gray-800 text-white disabled:text-gray-400 font-semibold text-sm rounded-lg transition-colors flex items-center gap-2"
              >
                {updatingPassword ? (
                  <>
